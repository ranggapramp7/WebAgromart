...
<div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="image/home/agro.jpg" style="width: 100%;  height: 700px;">
	</div>
</div>
<br>
<br>
...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #ff8d87; border-bottom: 2px solid #ff8d87;">"Agromart: Temukan hasil pertanian segar langsung dari petani lokal terpercaya. Rasakan kemudahan belanja dengan harga terjangkau, kualitas unggul, dan dukung keberlanjutan agribisnis Indonesia!"</h4>
	...
	<div class="row">
		...
		while ($row = mysqli_fetch_assoc($result)) {
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					<img src="image/produk/<?= $row['image'] ?>" class="product-img">
					<div class="caption">
						<h3><?= $row['nama'];  ?></h3>
...
<style>
    .product-img {
        ...
        height: 280px;     /* Tentukan tinggi gambar */
        object-fit: cover; /* Memastikan gambar akan di-crop jika perlu dan proporsi terjaga */
    }
</style>
