...
<div class="container">
		<h2 style=" width: 100%; border-bottom: 4px solid #ff8680"><b>Panduan Penggunaan</b></h2>
	<div class="bs-acc">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading" style="background-color: #eee;">
					<h4 class="panel-title">
						Bagaimana Cara Berbelanja di AGROMART ?
					</h4>
				</div>
				</a>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<ol>
							...
							<li>Masuk/Login menggunakan akun yang telah dibuat</li>
