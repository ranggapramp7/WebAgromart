		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-left">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-folder-close"></i> Manajemen Data <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="m_produk.php">Manajemen Produk</a></li>
							<li><a href="m_customer.php">Manajemen Customer</a></li>
						</ul>
					</li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="inventory.php">Stok Barang</a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="laporan_inventory.php">Laporan Stok Barang</a></li>
						</ul>
					</li>
