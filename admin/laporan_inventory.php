...
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid gray; padding-bottom: 5px;"><b>Laporan Stok Barang</b></h2>
	<div class="row print">
		<div class="col-md-9">
	...
	<table class="table table-striped">
		...
		?>
		<tr>
			<td colspan="5" class="text-right"><b>Jumlah semua bahan baku = <?= $total; ?> kg</b></td>
		</tr>
<?php 	} ?>
	</table>
</div>
